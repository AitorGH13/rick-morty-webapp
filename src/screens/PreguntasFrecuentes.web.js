    ...
    <div className="screenPreguntasFrecuentes">
      ...
      >
        ...
        <details className="pregunta_container">
          <summary
            id="faq1"
            className="subtitle_preguntas_frecuentes"
            role="button"
            aria-expanded="false"
          >
          ...
          <div
            className="pregunta_contenido"
            role="region"
            aria-labelledby="faq1"
          >
            <p className="text_preguntas_frecuentes">
              Como su propio nombre indica, se trata de un pequeño sitio donde
              recopilamos información sobre la serie Rick y Morty para que los
              más curiosos puedan acceder de forma fácil y visual.
            </p>
          </div>
        </details>
        ...
        <details className="pregunta_container">
          ...
          >
            <p id="faq2" className="text_preguntas_frecuentes">
              ...
              dedicada a un aspecto diferente de la serie. Puedes navegar por
              ellas desde el menú principal.
            </p>
          </div>
        </details>
        ...
        <details className="pregunta_container">
          ...
          >
            <p id="faq3" className="text_preguntas_frecuentes">
              ...
              hasta la última temporada de la serie. Se muestran datos hasta la
              temporada 5, incluida. Seguiremos trabajando para ofrecer los
              datos de los episodios más actuales.
            </p>
          </div>
        </details>
        ...
        <details className="pregunta_container">
          ...
          >
            <p id="faq4" className="text_preguntas_frecuentes">
              No, no puedes ver episodios directamente desde esta web. Te
              recomendamos que uses plataformas oficiales para disfrutar de la
              serie.
            </p>
          </div>
        </details>
        ...
        <details className="pregunta_container">
          ...
          >
            <p id="faq5" className="text_preguntas_frecuentes">
              ...
              disponible en la sección de <em>Sobre Nosotros</em>.
            </p>
          </div>
        </details>
        ...
        <details className="pregunta_container">
          ...
          >
            <p id="faq6" className="text_preguntas_frecuentes">
              Los datos mostrados en la web provienen de la{' '}
              <a
                className="link_faq"
              ...
              , que ofrece información detallada sobre los episodios, personajes
              y otros aspectos de la serie.
            </p>
          </div>
        </details>
        ...
        <details className="pregunta_container">
          ...
          >
            <p id="faq7" className="text_preguntas_frecuentes">
              Sí, estamos abiertos a cualquier tipo de contribución. Puedes
