...
function SobreNosotros() {
  const aitor = {
    ...
    foto: '/rick-morty-webapp/images/aitor.png',
  ...
  const ruben = {
    ...
    foto: '/rick-morty-webapp/images/ruben.jpeg',
  ...
  const aritz = {
    ...
    foto: '/rick-morty-webapp/images/aritz.jpg',
  ...
  const paula = {
    ...
    foto: '/rick-morty-webapp/images/paula.jpg',
  ...
  return (
    <div className="screenSobreNosotros">
      <div className="container_sobre-nosotros">
        ...
        <div
          className="div_background-blur-sobre-nosotros"
          aria-hidden="true"
        ></div>
