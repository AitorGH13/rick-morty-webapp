...
function Home() {
  ...
  const frases = [
    ...
    {
      texto:
        '"Supongo que simplemente soy el papel de baño de toda esta familia."',
    },
    {
      texto:
        '"¡Está bien! La televisión dice que no hay nada de que preocuparnos."',
    },
    {
      texto:
        '"Es un golpe duro, Morty, y lentamente se desvanece dejándote varado en un matrimonio fallido. Yo lo hice. Tus padres lo harán."',
    },
    {
      texto:
        '"Si he aprendido una cosa, es que antes de llegar a algún lado en la vida, debes dejar de escucharte a ti mismo."',
    },
    {
      texto:
    ...
    {
      texto:
        '"Las mantis religiosas son lo opuesto a los ratones de campo, Morty. Decapitan y se comen a sus compañeros después de aparearse. El amor no existe después de todo."',
    },
    {
      texto:
        '"Montón de gente corriendo alrededor chocando uno con el otro. Un tipo enfrente diciendo «dos más dos» y la gente atrás dice «cuatro»."',
    },
    {
      texto:
        '"El universo es como un animal, se alimenta de lo anodino. Crea infinitos idiotas para luego comérselos."',
    },
    {
      texto:
        '"¿Sabes lo mejor que puedes hacer por las personas que dependen de ti? Sé honesto con ellos, incluso si eso significa liberarlos."',
    },
    {
      texto:
        '"¿Cuántos de estos son errores horribles que cometí? Quiero decir, tal vez dejaría de cometer tantos si me dejara aprender de ellos."',
    },
    {
      texto:
